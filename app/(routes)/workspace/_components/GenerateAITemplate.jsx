...
function GenerateAITemplate({setGenerateAIOutput}) {
    ...
    return (
        <div>
            <Button variant="outline" className="flex gap-2" onClick={()=>setOpen(true)}><LayoutGrid className='h-4 w-4' />Generate AI Template</Button>
            <Dialog open={open}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                           ...
                           <div className='mt-5 flex gap-5 justify-end'>
                            ...
                            onClick={()=>GenerateForm()}>{loading?<Loader2Icon className='animate-spin'/>:'Generate'}</Button>
                           </div>
                        </DialogDescription>
                    </DialogHeader>
                </DialogContent>
