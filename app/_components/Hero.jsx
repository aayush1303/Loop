...
function Hero() {
  ...
  <div className="relative" id="home">
    ...
    <div className="text-left">
        <h6 className="text-xl font-semibold text-gray-700 dark:text-white">The Lowest Price</h6>
        <p className="mt-2 text-gray-500 w-[80%]">We offer the most competitive prices in the market. Our pricing is designed to provide you with the best value for your money.</p>
    </div>
    <div className="text-left">
        <h6 className="text-lg font-semibold text-gray-700 dark:text-white">The Fastest on the Market</h6>
        <p className="mt-2 text-gray-500 w-[80%]">Experience unparalleled speed and efficiency with our products. Our cutting-edge technology ensures the quickest results for your needs.</p>
    </div>
    <div className="text-left">
        <h6 className="text-lg font-semibold text-gray-700 dark:text-white">The Most Loved</h6>
        <p className="mt-2 text-gray-500 w-[80%]">Join the community of satisfied customers who love our products. Our exceptional service and quality have made us a favorite among users.</p>
    </div>
</div>
